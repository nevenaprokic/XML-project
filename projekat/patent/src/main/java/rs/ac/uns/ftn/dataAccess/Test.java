...
public class Test {
	...
	public static void main(String[] args) {
		PatentDataAccess da = new PatentDataAccess();
...
//		testXQuery(da);
	...
	private static void testUpdate(PatentDataAccess da) {
		da.updateDocument("A1.xml", "//Autori/Autor[@primarni = 'true']/zaj:Ime", "<zaj:Ime>PERAA</zaj:Ime>");
	}
	private static void testGetZahtevById(PatentDataAccess da) {
		ZahtevZaPriznanjePatenta delo = da.getZahtevById("A1.xml");
		System.out.println(delo);
	}
	
	public static void testSaveFile(PatentDataAccess da) {
		da.saveFile("A1.xml", "data/A1.xml");
	}
	private static void testXPath(PatentDataAccess da) {
