	...
	<xsl:template match="/">
		<html>
			<head>
				...
				<title>Resenje o priznanju zahteva za priznanje patenta </title>
				...
				<tbody>
					...
					<xsl:choose>
						<xsl:when test="re:Resenje/@status = 'odobren'">
                        	<td class="header">
								Ovim resenjem priznaje se Zahtev za priznanje patenta zavedeno pod brojem
                        ...
                        <xsl:when test="re:Resenje/@status = 'odbijen'">
                        	<td class="header">
								Ovim resenjem odbija se Zahtev za priznanje patenta zavedeno pod brojem
								<span><xsl:value-of select="re:Resenje/re:Dodatak/re:Sifra"/><xsl:text></xsl:text></span>.
