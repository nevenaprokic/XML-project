        ...
        <html>
            ...
            <body>
                                            ...
                                            <tr style="margin:0; padding:0;">
                                                ...
                                                <img style="width: 200px; height:200px; margin-bottom:220px;">
	                                                 <xsl:attribute name="src">
								                        <xsl:value-of select="z:Zahtev_za_priznanje_ziga/z:Zig/z:Izgled_znaka"/>
								                    </xsl:attribute>
							                    </img>
                                                </p></td>
                                            </tr>
                                        ...
                                        <table class="table-in" style="margin:0; padding:0;">
                                            ...
                                            <tr stzle="padding:0;">
                                                ...
                                                <td class="question" style="width:30%;">
                                                    <p> 
                                                        <xsl:choose>
                                                            <xsl:when test="z:Zahtev_za_priznanje_ziga/z:Prilozi_uz_zahtev/z:Primerak_znaka/z:Dostavljeno = 'true'">
                                                                <p>
                                                                    Dostavljeno
                                                                </p>
                                                            </xsl:when>
                                            ...
                                            <tr>
                                                ...
                                                <td class="question" style="width:30%;">
                                                    <p>
                                                        <xsl:choose>
                                                            <xsl:when test="z:Zahtev_za_priznanje_ziga/z:Prilozi_uz_zahtev/z:Spisak_robe_i_usluga/z:Dostavljeno = 'true'">
                                                                <p>
                                                                    Dostavljeno
                                                                </p>
                                                            </xsl:when>
                                            ...
                                            <tr>
                                                ...
                                                <td class="question" style="width:30%;">
                                                    <p>
                                                        <xsl:choose>
                                                            <xsl:when test="z:Zahtev_za_priznanje_ziga/z:Prilozi_uz_zahtev/z:Punomocje/z:Dostavljeno = 'true'">
                                                                <p>
                                                                    Dostavljeno
                                                                </p>
                                                            </xsl:when>
                                            ...
                                            <tr>
                                                ...
                                                <td class="question" style="width:30%;">
                                                    <p>
                                                        <xsl:choose>
                                                            <xsl:when test="z:Zahtev_za_priznanje_ziga/z:Prilozi_uz_zahtev/z:Punomocje_ranije_prilozeno/z:Dostavljeno = 'true'">
                                                                <p>
                                                                    Dostavljeno
                                                                </p>
                                                            </xsl:when>
                                            ...
                                            <tr>
                                                ...
                                                <td class="question" style="width:30%;">
                                                    <p>
                                                        <xsl:choose>
                                                            <xsl:when test="z:Zahtev_za_priznanje_ziga/z:Prilozi_uz_zahtev/z:Punomocje_naknadno_dostavljeno/z:Dostavljeno = 'true'">
                                                                <p>
                                                                    Dostavljeno
                                                                </p>
                                                            </xsl:when>
                                            ...
                                            <tr>
                                                ...
                                                <td class="question" style="width:30%;">
                                                    <p>
                                                        <xsl:choose>
                                                            <xsl:when test="z:Zahtev_za_priznanje_ziga/z:Prilozi_uz_zahtev/z:Opsti_akt_o_kolektivnom_zigu_garancije/z:Dostavljeno = 'true'">
                                                                <p>
                                                                    Dostavljeno
                                                                </p>
                                                            </xsl:when>
                                            ...
                                            <tr>
                                                ...
                                                <td class="question" style="width:30%;">
                                                    <p>
                                                        <xsl:choose>
                                                            <xsl:when test="z:Zahtev_za_priznanje_ziga/z:Prilozi_uz_zahtev/z:Dokaz_o_pravu_prvenstva/z:Dostavljeno = 'true'">
                                                                <p>
                                                                    Dostavljeno
                                                                </p>
                                                            </xsl:when>
                                            ...
                                            <tr>
                                                ...
                                                <td class="question" style=" width:30%;">
                                                    <p>
                                                        <xsl:choose>
                                                            <xsl:when test="z:Zahtev_za_priznanje_ziga/z:Prilozi_uz_zahtev/z:Dokaz_o_uplati_takse/z:Dostavljeno = 'true'">
                                                                <p>
                                                                    Dostavljeno
                                                                </p>
                                                            </xsl:when>
                ...
                <img style="width: 200px; height:200px;">
                    <xsl:attribute name="src">
                     	<xsl:value-of select="z:Zahtev_za_priznanje_ziga/z:Kod"/>
                 	</xsl:attribute>
                </img>
            </body>
        </html>
